...
<html lang="en">
  <head>
	...
	<link rel="stylesheet" href="<?= get_stylesheet_directory_uri().'/css/'; ?>jquery.bxslider.css">
	<link rel="stylesheet" type="text/css" href="<?= get_stylesheet_directory_uri().'/css/'; ?>normalize.css" />
	<link rel="stylesheet" type="text/css" href="<?= get_stylesheet_directory_uri().'/css/'; ?>demo.css" />
	<link rel="stylesheet" type="text/css" href="<?= get_stylesheet_directory_uri().'/css/'; ?>set1.css" />
	<link href="<?= get_stylesheet_directory_uri().'/css/'; ?>overwrite.css" rel="stylesheet">
  ...
  <body>
		...
		<div class="row">
			<div class="slider">
				<div class="img-responsive">
					<ul class="bxslider">				
						<li><img src="<?= get_stylesheet_directory_uri().'/img/'; ?>01.jpg" alt=""/></li>								
						<li><img src="<?= get_stylesheet_directory_uri().'/img/'; ?>01.jpg" alt=""/></li>	
						<li><img src="<?= get_stylesheet_directory_uri().'/img/'; ?>01.jpg" alt=""/></li>			
					</ul>
				</div>	
	...
	<div class="content">
		<div class="grid">
			<figure class="effect-zoe">
				<img src="<?= get_stylesheet_directory_uri().'/img/'; ?>25.jpg" alt="img25"/>
				<figcaption>
			...
			<figure class="effect-zoe">
				<img src="<?= get_stylesheet_directory_uri().'/img/'; ?>26.jpg" alt="img26"/>
				<figcaption>
					<h2>Title <span>Name</span></h2>
					<p class="icon-links">
						<a href="#"><span class="icon-heart"></span></a>
	...
	<div class="content">
		<div class="grid">
			<figure class="effect-zoe">
				<img src="<?= get_stylesheet_directory_uri().'/img/'; ?>27.jpg" alt="img27"/>
				<figcaption>
					<h2>Title <span>Name</span></h2>
					<p class="icon-links">
						<a href="#"><span class="icon-heart"></span></a>
			...
			<figure class="effect-zoe">
				<img src="<?= get_stylesheet_directory_uri().'/img/'; ?>30.jpg" alt="img30"/>
				<figcaption>
					<h2>Title <span>Name</span></h2>
					<p class="icon-links">
						<a href="#"><span class="icon-heart"></span></a>
    ...
    <script src="<?= get_stylesheet_directory_uri().'/js/'; ?>jquery-2.1.1.min.js"></script>
	...
	<script src="<?= get_stylesheet_directory_uri().'/js/'; ?>jquery.easing.1.3.js"></script>
	<script src="<?= get_stylesheet_directory_uri().'/js/'; ?>jquery.isotope.min.js"></script>
	<script src="<?= get_stylesheet_directory_uri().'/js/'; ?>jquery.bxslider.min.js"></script>
	<script type="text/javascript" src="<?= get_stylesheet_directory_uri().'/js/'; ?>fliplightbox.min.js"></script>
